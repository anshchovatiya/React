    ...
    >
      <label className="flex items-center cursor-pointer relative">
        <input
          type="checkbox"
          checked={check}
          className="peer h-4 w-4 cursor-pointer transition-all appearance-none rounded shadow hover:shadow-md border border-slate-300 checked:bg-[crimson] checked:border-[crimson] duration-200"
          id="check"
        />
      ...
      <div className="bg-[rgb(245,245,245)] py-7 mt-7 px-[15px] rounded md:p-8 text-sm">
        <div className="grid gap-5 max-h-[340px] overflow-y-auto !p-3 BillingDetails">
          {PRODUCTS.map((currentProduct) => {
            return (
              <div key={currentProduct.product_name} className="flex justify-between items-center">
