      ...
      <div className="min-w-screen min-h-screen bg-blue-100 flex items-center p-5 lg:p-20 overflow-hidden relative">
        <div className="flex-1 min-h-full min-w-full rounded-3xl bg-white shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left">
          <div className="w-full md:w-1/2">
            ...
            <div className="mb-3 md:mb-20 text-gray-600 font-light">
            ...
            <NavLink to="/" className="mb-20 md:mb-0 ">
              <button className="text-lg font-medium outline-none focus:outline-none transform transition-all hover:scale-110 text-yellow-500 hover:text-yellow-600 pb-8">
      ...
      <div className="flex items-end justify-end fixed bottom-0 right-0 mb-4 mr-4 z-10">
        <div>
          <div
            ...
            href="#"
            target="_blank"
            className="block w-16 h-16 rounded-full transition-all shadow hover:shadow-lg transform hover:scale-110 hover:rotate-12 cursor-pointer"
          >
            <img
